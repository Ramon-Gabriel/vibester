...
///
/// As fotos chegam prontas de quem abre a galeria: o detalhe do
/// estabelecimento já as recebe em `images` na mesma resposta que desenha o
/// resto da tela (`PlaceModel.imagensAmbiente`), então abrir a galeria não
/// custa uma segunda ida à rede — e por isso aqui não há carregamento nem
/// estado de erro para tratar.
  ...
  Widget _buildPhotos(BuildContext context) {
    ...
    if (photos.isEmpty) {
      return const VibesterState(
        headline: 'Sem fotos',
        message:
            'Esse lugar ainda não tem fotos do ambiente. Elas aparecem aqui '
            'assim que existirem.',
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      body: SafeArea(
        child: Stack(
          children: [
            Positioned.fill(child: _buildPhotos(context)),
